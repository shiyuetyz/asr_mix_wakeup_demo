...
public class English_part extends Activity {
				...
				runOnUiThread(new Runnable() {
					public void run() {
						stateNum = AppApplication
								.getNetChanged(English_part.this);
		...
		mMicrophoneControl.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				if (arg1.getAction() == MotionEvent.ACTION_DOWN) {
					if (Network.isNetworkConnected(English_part.this)) {
						if (mMicrophoneControl != null) {
							mMicrophoneControl.onAviable();
							mMicrophoneControl.setEnabled(true);
						...
						Toast.makeText(English_part.this, "当前无网络链接,无法识别！",
	...
	private void initRecognizer() {
		...
		mRecognizer.setLanguage("english");
